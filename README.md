...
3. **Port (optional)** – If your RomM instance runs on a non-standard port, enter it here. Most setups won't need this.
...
> [!NOTE]
> Grout currently does not support smart collections nor autogenerated collections.
...
[SCREENSHOT: Download progress screen]

You'll see a progress bar and list of games being downloaded. Grout downloads your ROMs directly from RomM to the
appropriate directory on your device.
...
[SCREENSHOT: Save sync scanning screen]
...
[SCREENSHOT: Emulator selection screen]
